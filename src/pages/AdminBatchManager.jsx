...
const AdminBatchManager = () => {
    ...
    return (
        <div className="p-6 space-y-8 bg-slate-50 min-h-screen overflow-x-hidden">
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
                    ...
                    <div className="bg-white w-full max-w-xl rounded-[2.5rem] p-10 relative shadow-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <button
                                className="w-full bg-slate-900 text-white py-4 rounded-2xl font-black uppercase hover:bg-blue-600 transition"
                            >
