                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="flex items-center gap-2 min-w-0">
                            ...
                            <span className="text-sm font-bold text-gray-800 truncate">{selectedComm?.name || '…'}</span>
                        </div>
                    </div>
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    {modules.length > 0 && (
                        <div className="mb-6 flex items-center gap-2 text-sm text-gray-500">
                            ...
                            <span>
                                <span className="font-bold text-gray-700">{modules.length}</span> module{modules.length !== 1 ? 's' : ''}
                                &nbsp;·&nbsp;
            ...
            {deleteTarget && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
                    <div className="bg-white w-full max-w-sm rounded-2xl shadow-2xl border border-gray-200 p-6">
                        ...
                        <p className="text-sm text-gray-600 bg-gray-50 border border-gray-100 rounded-xl px-4 py-3 mb-5 leading-relaxed">
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className="flex-1 py-2.5 rounded-xl border border-gray-200 text-sm font-semibold text-gray-600 bg-gray-50 hover:bg-gray-100 transition-colors disabled:opacity-50"
                            >
                                Cancel
                            </button>
                            <button
                    ...
                    <div className="flex flex-wrap items-center gap-2 mt-3">
                        {mod.topics?.length > 0 && (
                            <button
                                ...
                                className="inline-flex items-center gap-1.5 text-xs font-semibold text-blue-600 bg-blue-50 hover:bg-blue-100 px-2.5 py-1 rounded-lg transition-colors border border-blue-100"
                            >
                                <List size={12} />
                        ...
                        {mod.youtubeUrl && (
                            <span className="inline-flex items-center gap-1.5 text-xs font-semibold text-red-500 bg-red-50 px-2.5 py-1 rounded-lg border border-red-100">
                                <PlayCircle size={12} />
                                Video
                            </span>
                        )}
...
const EmptyState = ({ onAdd }) => (
    <div className="flex flex-col items-center justify-center py-24 px-6 text-center border-2 border-dashed border-gray-200 rounded-2xl bg-white">
