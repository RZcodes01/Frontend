...
export default function Community() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-blue-50 flex flex-col items-center justify-center space-y-4">
        ...
        <p className="text-blue-500 font-semibold text-base animate-pulse">Scanning the network...</p>
      </div>
    );
  }
  ...
  return (
    <section className="relative min-h-screen py-24 bg-blue-50 overflow-hidden selection:bg-amber-400/30">
      ...
      <div className="relative container mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-blue-600 text-xl leading-relaxed mb-10 font-medium">
          ...
          <div className="relative max-w-xl mx-auto group">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full pl-14 pr-6 py-4 bg-blue-100 backdrop-blur-xl border-2 border-blue-200 rounded-2xl text-blue-950 text-base font-medium placeholder-blue-400 focus:outline-none focus:ring-2 focus:ring-amber-400/50 focus:border-amber-400/50 transition-all shadow-sm"
              />
            </div>
          </div>
        </div>
        ...
        {filteredCommunities.length === 0 ? (
          <div className="text-center py-20">
            <div className="w-20 h-20 bg-blue-100 rounded-3xl flex items-center justify-center mx-auto mb-6 border border-blue-200 shadow-inner">
              <Search size={32} className="text-blue-300" />
            </div>
            <h3 className="text-3xl font-black text-blue-900 mb-3">No matches found</h3>
            <p className="text-blue-500 text-lg font-medium mb-8">Try adjusting your keywords or browse everything.</p>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto pb-20">
            {filteredCommunities.map((community) => (
              <div
                ...
                className="group relative flex flex-col bg-white border-2 border-blue-300 rounded-[2rem] overflow-hidden transition-all duration-500 hover:border-amber-400 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgba(30,58,95,0.2)] cursor-pointer shadow-md"
              >
                {/* Banner Image */}
                <div className="relative h-48 w-full overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 backdrop-blur-md bg-blue-950/60 border border-blue-600/40 px-3 py-1.5 rounded-full flex items-center gap-2">
                    ...
                    <span className="text-xs font-black text-blue-50 uppercase tracking-wider">
                ...
                <div className="p-8 flex flex-col flex-grow">
                  <h3 className="text-2xl font-black text-blue-900 mb-3 group-hover:text-amber-500 transition-colors leading-tight">
                    {community.name}
                  </h3>

                  <p className="text-blue-600 text-base font-medium line-clamp-2 mb-8 leading-relaxed">
                  ...
                  <div className="mt-auto flex items-center justify-between pt-6 border-t border-blue-100">
                    <div className="flex items-center -space-x-2">
                      ...
                      <span className="pl-4 text-xs font-bold text-blue-400 uppercase tracking-tighter">+ Active</span>
                    </div>

                    <div className="flex items-center gap-2 text-sm font-black text-amber-500 uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-all translate-x-4 group-hover:translate-x-0">
