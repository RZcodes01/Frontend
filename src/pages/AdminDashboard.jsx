      ...
      <aside className="w-64 bg-slate-900 text-white p-6">
        ...
        <nav className="space-y-4">
          ...
          <button onClick={() => setActiveTab('enrollments')}
            className={`w-full flex gap-3 p-3 rounded-xl ${activeTab === 'enrollments' ? 'bg-blue-600' : 'text-gray-400'}`}>
            <Users size={20} /> Enrollment
          </button>

          <button onClick={() => setActiveTab('batch')}
            className={`w-full flex gap-3 p-3 rounded-xl ${activeTab === 'batch' ? 'bg-blue-600' : 'text-gray-400'}`}>
            <Users size={20} /> Batch
          </button>
